...
namespace ServiceHost.Areas.Administration.Pages.Shop.Orders
{
	public class IndexModel : PageModel
	{
		...
		public void OnGet(OrderSearchModel searchModel)
		{
			...
			Accounts = new SelectList(_accountApplication.GetAllAccounts(), "Id", "Fullname");
		}
		public IActionResult OnGetConfirm(long id)
		{
			_orderApplication.PaymentSucceed(id, 0);
		...
		{
			var result = _orderApplication.GetItems(id);
			return Partial("Items", result);
		}
	}
}
